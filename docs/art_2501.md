...
> 原文：[`developer.ibm.com/zh/articles/os-cn-apache-flink/`](https://developer.ibm.com/zh/articles/os-cn-apache-flink/)
...
![图 1\. Flink 架构图](img/8c100be612639e5f3a2b7966a5b3bc63.png)
...
![图 2\. Flink 的 Stack](img/dc0b7ca19b54f35e73adbc4329b6899f.png)
...
![图 3\. Flink 的目录结构](img/afaed1a0bbca21c960689b2ae5ec32bf.png)
...
![图 4\. 启动 StandAlone 模式的 Flink](img/044f8e593f7ea905a125919a41073c08.png)
...
![图 5\. Flink 的 GUI 页面](img/fd542b80de6c31bccb5a0ed458740cef.png)
...
![图 6\. Flink 与 Yarn 的关系](img/b2650420c2d19b08371947f4215a074c.png)
...
![图 7\. Flink on Yarn](img/fdc3c40e530ece4467af91575da0cc8e.png)
...
![图 8\. Flink 的页面](img/bcb81a914755eb3dba770edf20fa4fcf.png)
...
3.  查询一个指定的 Job 信息: /jobs/jobid。这个查询的结果会返回特别多的详细的内容，这是我在浏览器中进行的测试，如下图：
    ...
    ![图 9\. Rest 查询具体的 Job 信息](img/83f9c227e8191e7ca48661958cc89c1c.png)
