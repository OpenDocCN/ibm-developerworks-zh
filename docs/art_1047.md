...
![图 1\. 不同版本的规范的差异](img/cd9d0d302aa9ef30ff4c710edd17ca8c.png)
...
![图 3\. Spring Boot、Spring Validation 和 Hibernate Validator 的调用关系](img/644353719d5f613b2e8c8513906cdaf6.png)
