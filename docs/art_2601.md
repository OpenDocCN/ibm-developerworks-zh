...
![图 1\. Quartz 核心元素关系图](img/0c5dbe79f7eb71d5d27ff49dbaabdfbb.png)
...
1.  准备数据库和 Quartz 用的数据表
    ...
    ![图 6\. Quartz 数据表](img/c7084d4d47d8e6a1eb212a742cce3238.png)
...
6.  运行程序，查看数据库表和运行结果
    ...
    图 11\. QRTZ_TRIGGERS 表中的记录 {: #图-11-qrtz-triggers-表中的记录}
