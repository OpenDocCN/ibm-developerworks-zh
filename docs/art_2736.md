...
> 原文：[`developer.ibm.com/zh/articles/j-lo-tomcat2/`](https://developer.ibm.com/zh/articles/j-lo-tomcat2/)
...
![图 1\. 门面示意图](img/8621d6ddb6fdf16ff45cd1bbfd7d7f14.png)
...
![图 2\. Request 的门面设计模式类图](img/a20a1815afd94a8492d21c354560f134.png)
...
![图 3\. Lifecycle 的观察者模式结构图](img/0b5e635c7007c6057a4e24e9d0510e4b.png)
...
![图 4\. Tomcat 命令模式的结构图](img/18eaad64fdeefb801b700c9d91b86ee5.png)
...
![图 5\. Tomcat 责任链模式的结构图](img/c567cf70dbc8e9c7bd1f64a1e81f8104.png)
