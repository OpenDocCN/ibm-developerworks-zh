...
![图 2\. Statement 有关的类结构图](img/734accd3989450afe89e461bfcee3c83.png)
...
![图 6\. 映射参数值到数据库过程时序图](img/ca244e4e4f01ae813ea263507d33ed90.png)
...
![图 7\. 映射返回对象时序图](img/cce64d1edc2b92ada3ac5bb685b864bc.png)
