...
> 原文：[`developer.ibm.com/zh/articles/os-cn-hadoop-name-node/`](https://developer.ibm.com/zh/articles/os-cn-hadoop-name-node/)
...
![图 1\. HDFS NameNode 高可用整体架构](img/f8fa33c20d8c5c26a12e4384cd8029ae.png)
...
![图 2\. NameNode 的主备切换流程](img/e9ff48115c81ecab9f078eb7f248060b.png)
...
![图 4\. 基于 QJM 的共享存储系统的内部实现架构图](img/84d5b0f794ab45facd30496b32b68654.png)
...
![图 5\. 基于 QJM 的共享存储的数据同步机制 ](img/3f6cf8a6eaf81adec3b203ed74611767.png)
...
![图 6.Active NameNode 和 JournalNode 集群的交互流程图](img/f12a68208270f3e21bea7c640959a78e.png)
...
上一步执行完成之后，NameNode 确认大多数 JournalNode 上的 EditLog Segment 已经从基准数据源进行了同步。接下来，NameNode 向 JournalNode 集群发送 finalizeLogSegment RPC 请求，JournalNode 接收到请求之后，将对应的 EditLog Segment 从 in-progress 状态转换为 finalized 状态，实际上就是将文件名从 edits*inprogress*${startTxid} 重命名为 edits_${startTxid}-${endTxid}，见”NameNode 的元数据存储概述”一节的描述。
...
![图 7\. JournalNode 集群写入的事务 id 情况](img/cae240390e9f3119aa21200bdd23a7ff.png)
