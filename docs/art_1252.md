...
![在数据模型中定义数据](img/e87e695e60757f88fbba01af3db79d65.png)
...
![对 If 分支中的 AsaNa 节点进行配置](img/463deb02a9b1b42bd1d29d914df8c477.png)
...
![对 else 分支中的 Slack 节点进行配置](img/5d0f3c32db81a87ba669ff1616cd2be3.png)
