...
示例代码中每一行<config-type>字段，用来指定一个配置文件。一个 Service 可以同时指定多个配置文件。不过所有的配置文件必须放在 Service 的 configuration 目录中。</config-type>
...
![图 2\. 自定义 Service 的配置页面](img/a5d40f8542fbb9403c046d62f0708805.png)
