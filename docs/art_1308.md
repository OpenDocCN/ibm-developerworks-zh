...
OTP 请求 展示了如何使用设备属性打开和关闭 OTP 身份验证。如果启用了 OTP 身份验证，设备会在启动后使用正常的 MQTT 消息向 IoT 代理应用程序发送 OTP 请求。
...
![详细的流程](img/c83ce0042fd8a1d0295a8b7d95d5f699.png)
...
![设备模拟器样本应用程序的屏幕截图](img/7a3341828650abb029f5255b34aa5ce2.png)
