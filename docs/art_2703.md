...
> 原文：[`developer.ibm.com/zh/articles/j-lo-servlet/`](https://developer.ibm.com/zh/articles/j-lo-servlet/)
...
![图 1 . Tomcat 容器模型](img/c3702a099408bcaee43c6470c89040a1.png)
...
![图 2\. Tomcat 主要类的启动时序图](img/75741e2fdcacf7505d51ba96a137765f.png)
...
![图 3\. 创建 Servlet 对象的相关类结构](img/b6514b23baca69593d3be8cc5a020f37.png)
...
![图 4\. 初始化 Servlet 的时序图](img/18fcdca914beac16b376d011079a06ae.png)
...
![图 5.Servlet 顶层类关联图](img/a38828a83adbe1201f233e70092e1011.png)
...
![图 6\. ServletConfig 在容器中的类关联图](img/dcba516cf9e68b09680e75b0a89f11a2.png)
...
![图 7.Request 相关类结构图](img/b86af696c1aaa5a4d44202011c8abc1a.png)
...
![图 8.Request 和 Response 的转变过程](img/b3be6d870a4e70a0a112715fc1acdbe8.png)
...
![图 9.Request 的 Mapper 类关系图](img/a1a79df7b9364c130b6b84fc568c4c0b.png)
...
![图 10.Request 在容器中的路由图](img/fe5ff4a3c06785df05cab6d76aaadbf3.png)
...
![图 11.Session 相关类图](img/20d97fe5f103aff34ff4cbda3b3c5f4f.png)
...
![图 12.Session 工作的时序图](img/25e0f4d9c63a175dfbb4713728e33636.png)
...
![图 13.Servlet 中的 Listener](img/1dd36f0bfcc68b7b48434ffc992dc6a0.png)

它们基本上涵盖了整个 Servlet 生命周期中，你感兴趣的每种事件。这些 Listener 的实现类可以配置在 web.xml 中的 <listener>标签中。当然也可以在应用程序中动态添加 Listener，需要注意的是 ServletContextListener 在容器启动之后就不能再添加新的，因为它所监听的事件已经不会再出现。掌握这些 Listener 的使用，能够让我们的程序设计的更加灵活。</listener>
