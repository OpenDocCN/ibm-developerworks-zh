...
> 原文：[`developer.ibm.com/zh/articles/j-lo-chinesecoding/`](https://developer.ibm.com/zh/articles/j-lo-chinesecoding/)
...
![Figure xxx. Requires a heading](img/c024f031a9084d55d169feb89a38a360.png)
...
![Figure xxx. Requires a heading](img/930ea523d5247de869355f6832c2425e.png)
...
![图 1\. Java 编码类图](img/a9864bbc7c6e1572d4c43bf28be3df8c.png)
...
![图 2.Java 编码时序图](img/b184360f8b4eac376cfb05639b0fc982.png)
...
![Figure xxx. Requires a heading](img/09fc83f2b8594cf5f61b36da177b3065.png)
...
![Figure xxx. Requires a heading](img/c70b5173285a09d4472ce86e5f032b84.png)
...
![Figure xxx. Requires a heading](img/bd52693b6dc5ad8bf518f317c2483c2e.png)
...
![Figure xxx. Requires a heading](img/f047ad66921ad5afec9664880c028d18.png)
...
![Figure xxx. Requires a heading](img/3c321169212cfffd6a725987fa3b9a26.png)
...
![图 3\. 一次 HTTP 请求的编码示例](img/6f178a023679c7d5f6b148936f27b28f.png)
...
![图 4.URL 的几个组成部分](img/1c62351bd91be09d7e227f3426ca0eb6.png)

上图中以 Tomcat 作为 Servlet Engine 为例，它们分别对应到下面这些配置文件中：

Port 对应在 Tomcat 的 <connector port="8080">中配置，而 Context Path 在 <context path="/examples">中配置，Servlet Path 在 Web 应用的 web.xml 中的</context></connector>
...
<url-pattern>中配置，PathInfo 是我们请求的具体的 Servlet，QueryString 是要传递的参数，注意这里是在浏览器里直接输入 URL 所以是通过 Get 方法请求的，如果是 POST 方法请求的话，QueryString 将通过表单方式提交到服务器端，这个将在后面再介绍。</url-pattern>
...
![图 5\. HTTPFox 的测试结果](img/f187b91d45a66a8f56a845ab47253c26.png)
...
![Figure xxx. Requires a heading](img/fc5d8b9aeb8ce41f8e19dc525878f746.png)
...
![Figure xxx. Requires a heading](img/b957d887a2e9674d76882537308aa65a.png)
...
![Figure xxx. Requires a heading](img/50a130ab5b07ed162e32363eb007cfc8.png)
...
![Figure xxx. Requires a heading](img/ae39c1502fa1058dd2ae57beb8fc01bd.png)
