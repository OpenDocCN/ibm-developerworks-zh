...
![alt](img/fa3bedda1a6c394fe989f52ef9777e6e.png)
...
上表中有一些类似于 birth *| (birth* & baby * )这样的字段，这种是 SPSS Modeler 自带的模式匹配的类别规则，此处不再详述，如读者感兴趣可以去查询模式匹配的相关规则语法，其他的注入 Baby girl，Baby boy 等单词短语是很容易理解的。
