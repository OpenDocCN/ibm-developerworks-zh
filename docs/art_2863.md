...
> 原文：[`developer.ibm.com/zh/articles/l-javainterface-abstract/`](https://developer.ibm.com/zh/articles/l-javainterface-abstract/)
...
在语法层面，Java 语言对于 abstract class 和 interface 给出了不同的定义方式，下面以定义一个名为 Demo 的抽象类为例来说明这种不同。
