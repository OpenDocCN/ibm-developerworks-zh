...
![底部的 tabs 布局方式](img/c0a7f68385766af090fda77dadee9bd0.png)

##### 图 3\. 侧边栏的 menu 布局方式

![侧边栏的 menu 布局方式](img/749aca9442862934dacfc7ddf83ec985.png)
...
![使用 grid 分割页面布局](img/67eb5851c3f7f1fe5ae51c023a7ec1c8.png)
...
![真机测试](img/1d27b34baac23ca1f6234f1cb38a66f2.png)
